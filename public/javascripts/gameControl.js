...
function changeSlide(r){
    ...
    function bg(n) {
        ...
        r.css({
            'background-image': '-webkit-linear-gradient(left ,#16a085 0%,#16a085 ' + n + '%,#fff ' + n + '%, #fff 100%)'
        });
    }
}
...
function enterConsentPage(workerID) {
    ...
    $("#consentDecline-button").click(function() {
        $('#consentAgree-button').css({
            'display': 'none'
        });
        $('#consentDecline-button').css({
            'display': 'none'
        });
        $(".consent-form-box").css({
            'display': 'none'
        });
        $('.consent-instructions').css({
            'top': '45%'
        })
